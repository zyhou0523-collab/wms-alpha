<template>
  <main class="page with-tab">
    ...
    <section class="quick-row">
      <van-button type="primary" block @click="notifyPrepared('库存移动')">库存移动</van-button>
      <van-button block @click="notifyPrepared('库存盘点')">库存盘点</van-button>
...
function notifyPrepared(action: string) {
  success(`${action}入口已响应，后续将接入 PC 端业务接口`)
}
